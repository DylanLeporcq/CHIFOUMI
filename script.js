...
function clickR() {
    ...
    scores.style.visibility='hidden';
    {
        if (x === 1) {
            ...
            resultp1.innerHTML='Réunion TuPierreWare, vous avez fait une égalité. Clickez sur "Manche suivante" !';
        } else if (x === 2) {
            choicebot.style.backgroundImage = "url(assets/img/paperRight.png)";
            resultp1.innerHTML='La pierre est recouverte par le papier, vous avez perdu cette manche ! Clickez sur "Manche suivante" !';
            scoreJ2 = scoreJ2+1;
            botPT.innerHTML = scoreJ2;
        } else if (x === 3) {
            choicebot.style.backgroundImage = "url(assets/img/scissorsRight.png)";
            resultp1.innerHTML='La pierre broye les ciseaux, vous avez gagné cette manche ! Clickez sur "Manche suivante" !';
            scoreJ1 = scoreJ1+1;
            playerPT.innerHTML = scoreJ1;
        }
    }
...
function clickP() {
    ...
    scores.style.visibility='hidden';
    {
        if (x === 1) {
            choicebot.style.backgroundImage = "url(assets/img/rockRight.png)";
            resultp1.innerHTML='Le papier recouvre la pierre, vous avez gagné cette manche ! Clickez sur "Manche suivante" !';
            scoreJ1 = scoreJ1+1;
            playerPT.innerHTML = scoreJ1;
        } else if (x === 2) {
            choicebot.style.backgroundImage = "url(assets/img/paperRight.png)";
            resultp1.innerHTML='Calin de feuilles de papier, vous avez fait une égalité. Clickez sur "Manche suivante" !';
        } else if (x === 3) {
            choicebot.style.backgroundImage = "url(assets/img/scissorsRight.png)";
            resultp1.innerHTML='Le papier est découpé par les ciseaux, vous avez perdu cette manche ! Clickez sur "Manche suivante" !';
            scoreJ2 = scoreJ2+1;
            botPT.innerHTML = scoreJ2;
        }
    }
...
function clickS() {
    ...
    scores.style.visibility='hidden';
    {
        if (x === 1) {
            choicebot.style.backgroundImage = "url(assets/img/rockRight.png)";
            resultp1.innerHTML='Les ciseaux sont broyés par la pierre, vous avez perdu cette manche ! Clickez sur "Manche suivante" !';
            scoreJ2 = scoreJ2+1;
            botPT.innerHTML = scoreJ2;
        } else if (x === 2) {
            choicebot.style.backgroundImage = "url(assets/img/paperRight.png)";
            ...
            playerPT.innerHTML = scoreJ1;
            choicebot.style.backgroundImage = "url(assets/img/scissorsRight.png)";
            resultp1.innerHTML='Combat de ciseaux laser, vous avez fait une égalité. Clickez sur "Manche suivante" !';
        }
    }
}
...
function nextClick() {
    ...
    resultp1.innerHTML='Choisissez la Pierre, la Feuille ou les Ciseaux !';
...
function clickE() {
    playerchoice.style.backgroundImage="url(assets/img/fuckLeft.png)";
    votes.style.display='none';
    music.play();
    next.style.display='block';
    scores.style.visibility='hidden';
    picPlayer.style.backgroundImage = "url(assets/img/original_thug.jpg)";
    {
        if (x === 1) {
            choicebot.style.backgroundImage = "url(assets/img/rockRight.png)";
            resultp1.innerHTML='Vous niquez cette putain de pierre, vous avez gagné cette manche ! Clickez sur "Manche suivante" !';
            scoreJ1 = scoreJ1+1;
            playerPT.innerHTML = scoreJ1;
        } else if (x === 2) {
            choicebot.style.backgroundImage = "url(assets/img/paperRight.png)";
            resultp1.innerHTML='Vous arrachez ce vieux post-it, vous avez gagné cette manche ! Clickez sur "Manche suivante" !';
            scoreJ1 = scoreJ1+1;
            playerPT.innerHTML = scoreJ1;
        } else if (x === 3) {
            choicebot.style.backgroundImage = "url(assets/img/scissorsRight.png)";
            resultp1.innerHTML='Vous enfilez cette paire de cisailles, vous avez gagné cette manche ! Clickez sur "Manche suivante" !';
            scoreJ1 = scoreJ1+1;
            playerPT.innerHTML = scoreJ1;
        }
    }
